...
file_name2 = "/home/parth/BE_Project/my_EmailRecommmendation/model/dataframe5.csv"
...
print('allow' in word2idx)
print(word2idx['allow'])
def indexer(s):
    vec = []
    for wr in nlp(s):
        wr = wr.text.lower()
...
#pprint(user_indices)
#pprint(trn_user_indices)
#pprint(tst_user_indices)
